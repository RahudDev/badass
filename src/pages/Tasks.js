...
const Tasks = () => {
  ...
  const tasks = [
    ...
    { id: 2, title: 'Watch Video', description: 'Watch a short video and earn $CUAN.', image: 'https://od.lk/s/NjFfODI4MTUxMDhf/person%20watch.jpg' , href: [isLoggedIn ? "#/tasks/provider2" : "#/signup"]},
