...
const PollfishSurvey = () => {
  ...
  useEffect(() => {
    const fetchSurvey = () => {
      const api_key = '13fa241a-95e6-407a-a741-c621f763c28f';
      const debug = true;
      const device_id = uniqueUserID;
      const request_uuid = '5ba3b063-046f-4cb6-b09d-c4f7ebafb1ba';
      const placement_key = 'fe451002-ded6-4cc4-b0f6-c0d9c3ca7a0f';
